    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController) {
        ...
        return GetBuilder<LocationController>(builder: (locationController) {
          ...
          //print("Address en la vista: " + _addressController.text);
          return SingleChildScrollView(
            ...
            children: [
                ...
                child: Stack(
                  children: [
                    GoogleMap(
                      ...
                      onCameraIdle: () {
                        //Enviamos a la base de datos, la posicion que se selecciona en el mapa
              ...
              Padding(
                  ...
                  child: BigText(text: "Dirección de envío")),
              SizedBox(
              ...
              Padding(
                  padding: EdgeInsets.only(left: Dimensions.width20),
                  child: BigText(text: "Número de teléfono")),
              SizedBox(
                height: Dimensions.height10,
              ),
              AppTextField(
